    ...
    <div className="bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 min-h-screen">
            ...
            <div className="text-center lg:text-left space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-2xl font-light">
                  Programmer • AI Developer • Web Developer • Passionate about
                  Tech
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  , an Informatics student at President University, specializing
                  in Artificial Intelligence. My primary interests include
                  Artificial Intelligence, Web Development, and building
                  AI-driven solutions.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  In addition to building Web and AI projects, I have a strong
                  interest in exploring emerging technologies to deepen my
                  understanding of modern systems and their real-world
                  applications.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  I am committed to continuous learning and actively seek new
                  challenges that allow me to further enhance my technical
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Full-Stack Applications & Modern Frameworks
                  </p>
                </div>
      ...
      <Element name="Experience-Section">
        <section
          id="experience"
          data-section
          className={`py-20 px-4 bg-gray-50 dark:bg-gray-800/50 transition-all duration-1000 ${
              ...
              <div className="space-y-12">
                ...
                <div className="relative flex items-start gap-8">
                  ...
                  <div className="flex-grow bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Actively seeking internship opportunities in AI
                      Development, Web Development, or related fields to enhance
                      my technical skills and gain real-world industry
                      experience.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex items-start gap-8">
                  ...
                  <div className="flex-grow bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                      President University Computer and Technology Enthusiast
                      Club, Head of External Division
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Managed external partnerships and represented the
                      organization in technology-related events. Coordinated
                      collaborations with other institutions and communities to
                      expand opportunities for members and promote knowledge
                      sharing.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex items-start gap-8">
                  ...
                  <div className="flex-grow bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                      PT Mattel Indonesia, AI Developer (Academic Collaboration)
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Developed an AI-based defect detection and root cause
                      analysis system as part of a final university project in
                      collaboration with PT Mattel Indonesia.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex items-start gap-8">
                  ...
                  <div className="flex-grow bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                      PUMA Informatics, Vice of Student Development and
                      Competition
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                      Led academic development programs, competitions, and
                      student support initiatives for Informatics students.
                      Promoted student participation in national-level events
                      and project showcases by collaborating with internal
                      committees.
                    </p>
                  </div>
                </div>
      ...
      <Element name="Certificates-Section">
        ...
        <section
          ...
          data-section
          className={`py-20 px-4 transition-all duration-1000 ${
            isVisible.additionalcertificates
              ? "opacity-100 translate-y-0"
              : "opacity-0 translate-y-10"
          }`}
        >
          ...
          <div className="space-y-12">
            <div className="text-center max-w-4xl mx-auto">
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                I have two years of programming experience, working with a wide
                range of programming languages, frameworks, and tools. My focus
                areas include web development and AI development, giving me the
                ability to contribute across the entire development lifecycle. I
                continuously strive to stay updated with the latest technologies
                and industry trends.
              </p>
            </div>
            ...
            <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-6">
              {[
                ...
                {
                  src: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-original-wordmark.svg",
                  name: "Firebase",
                },
                {
                  src: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/matplotlib/matplotlib-original-wordmark.svg",
                  name: "Matplotlib",
                },
                {
