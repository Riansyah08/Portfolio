...
export default function Navbar() {
  ...
  const scrollProps = {
    ...
    duration: 500,
    offset: -80,
    className: "relative cursor-pointer transition-all duration-300 hover:text-cyan-400 group",
  };
  ...
  return (
    <nav className="fixed top-0 w-full bg-slate-950/95 backdrop-blur-xl border-b border-slate-800/50 z-50 shadow-2xl">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-400 font-medium tracking-wide">AI & WEB DEVELOPER</span>
            </div>
          </div>
          ...
          {/* Mobile Menu Button */}
          <div 
            className="lg:hidden relative w-10 h-10 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300 hover:border-cyan-500/50"
